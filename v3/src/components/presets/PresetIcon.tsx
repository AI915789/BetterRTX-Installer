  ...
  return (
    <div className="@container contain-inline-size flex-1 shadow-md">
      <div className={cx("flex group flex-col items-center justify-center border border-white/10 outline @2xs:outline-2 outline-black h-min rounded-md @3xs:rounded-t-lg @3xs:rounded-b-xl relative overflow-hidden w-full",
        ...
        <img
          className="preset-icon transition-all @3xs:mx-0 mx-2 @3xs:rounded-t-md @3xs:rounded-b-lg object-cover mb-0.5 @3xs:mb-1 @2xs:mb-1.5 w-full h-full border border-white/30 blend-overlay shadow-none outline outline-black/25 relative inset-0 z-20"
          ...
          height={iconSize}
        />
        <div className="absolute transition-opacity opacity-75 group-hover:opacity-100 inset-0 w-full h-full object-cover rounded-md border border-black/15 from-black/25 via-white/75 to-white/30 group-hover:from-white/15 group-hover:via-white/50 group-hover:to-white/50 z-10 bg-radial">
          <img
